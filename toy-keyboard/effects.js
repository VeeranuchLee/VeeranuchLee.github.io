...
(function () {
  ...
  const THEMES = {
    ...
    princess: {
      ...
      /* Saturated on purpose (owner, 2026-09-14: "brighter sparkles"). The first
         palette was pastel on a pink castle and the bursts all but vanished. */
      colours: ["#ff1f8f", "#ffb400", "#8b3dff", "#00a6ff", "#e0007a", "#ff6a00", "#b100e8"],
    },
  };

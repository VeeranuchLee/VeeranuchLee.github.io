...
window.BOOK_NAV = {
  ...
  deepDives: [
    ...
    /* ---- Page 10: the asteroid belt (§7.2) ----
       A0 overview · A1 Ceres · A2 the other big ones · A3 what they are like ·
       A4 tap-and-hear. Page 10's "About Ceres" button opens this at A1 rather
       than at A0, which is what `data-deep-dive-page` on that button is for:
       the label promises Ceres, so the first page a child sees is Ceres. Back
       from there still walks to A0, because `back()` steps an index when there
       is no history to pop. */
    {
      ...
      pages: [
        {
          id: "a0",
          image: { src: "assets-runtime/standard/page-10/asteroid-cluster-extra-v1.webp", alt: "A sparse group of distant asteroids" },
          title: "The asteroid belt",
          subtitle: "Between Mars and Jupiter",
          layoutType: "overview-hotspots",
          body: "Between Mars and Jupiter, countless rocky worlds travel around the Sun — but the belt is mostly empty space. The rocks are so far apart that a spacecraft can fly straight through and never come near one.",
          hotspots: [
            { id: "ceres",  label: "Meet Ceres",     targetPage: "a1" },
            { id: "bigger", label: "The big ones",   targetPage: "a2" },
            { id: "like",   label: "What they look like", targetPage: "a3" },
            { id: "names",  label: "Say their names", targetPage: "a4" }
          ]
        },
        {
          id: "a1",
          image: { src: "assets-runtime/standard/page-10/ceres-main-v1.webp", alt: "Ceres" },
          title: "Ceres",
          subtitle: "The largest world in the belt",
          layoutType: "single-focus",
          body: "Ceres is the largest world in the asteroid belt, and it is round. Most asteroids are lumpy, so Ceres stands out. It is a dwarf planet: it is round and it goes round the Sun, and it shares the belt with a great many other rocks. A spacecraft called Dawn flew there and found bright salty deposits in a crater named Occator.",
          facts: [
            { label: "How wide",    value: "about 940 km" },
            { label: "A day there", value: "about 9 hours" },
            { label: "A year there", value: "about 4.6 Earth years" }
          ]
        },
        {
          id: "a2",
          image: { src: "assets-runtime/standard/page-10/vesta-hero-v1.webp", alt: "Vesta" },
          title: "The other big ones",
          subtitle: "Vesta, Pallas and Hygiea",
          layoutType: "compare",
          body: "Ceres is the biggest. These three come next, and Vesta is the second largest of all.",
          items: [
            { name: "Vesta",  note: "One of the biggest asteroids in the belt." },
            { name: "Pallas", note: "Almost as big as Vesta, on a steeply tilted path." },
            { name: "Hygiea", note: "A dark world, and rounder than anyone expected." }
          ]
        },
        {
          id: "a3",
          image: { src: "assets-runtime/standard/page-10/foreground-asteroid-a-v1.webp", alt: "Irregular foreground asteroid" },
          title: "What asteroids look like",
          subtitle: "Rocky, lumpy, and all different",
          layoutType: "compare",
          body: "Asteroids are rocky, and hardly any of them are round. Some are bright and some are as dark as coal. Some are covered in craters, and one of them even has a moon of its own.",
          items: [
            { name: "Psyche",   note: "A metal-rich world no spacecraft has reached yet." },
            { name: "Ida",      note: "This long, lumpy asteroid has its own tiny moon, called Dactyl." },
            { name: "Gaspra",   note: "The first asteroid a spacecraft ever visited up close." },
            { name: "Mathilde", note: "So dark it is like coal, with craters nearly as wide as itself." }
          ]
        },
        {
          id: "a4",
          title: "Say their names",
          subtitle: "Ten names from the belt",
          layoutType: "chips",
          body: "Tap a name. The spelling underneath shows how to say it out loud.",
          chips: [
            { label: "Ceres",    pron: "SEER-eez",      note: "The largest world in the asteroid belt." },
            { label: "Vesta",    pron: "VES-tuh",       note: "One of the biggest asteroids in the belt." },
            { label: "Pallas",   pron: "PAL-us",        note: "Almost as big as Vesta, on a steeply tilted path." },
            { label: "Hygiea",   pron: "hy-JEE-uh",     note: "A dark world, and rounder than anyone expected." },
            { label: "Juno",     pron: "JOO-noh",       note: "A stony asteroid with a big bite taken out of one side." },
            { label: "Psyche",   pron: "SY-kee",        note: "A metal-rich world no spacecraft has reached yet." },
            { label: "Lutetia",  pron: "loo-TEE-shuh",  note: "Rosetta flew past and found a battered, grooved surface." },
            { label: "Mathilde", pron: "muh-TIL-duh",   note: "So dark it is like coal, with craters nearly as wide as itself." },
            { label: "Ida",      pron: "EYE-duh",       note: "This long, lumpy asteroid has its own tiny moon, called Dactyl." },
            { label: "Gaspra",   pron: "GAS-pruh",      note: "The first asteroid a spacecraft ever visited up close." }
          ]
        }
      ]
    },

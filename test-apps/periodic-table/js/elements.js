...
(function () {
  ...
  const ELEMENT_ROWS = [
    ...
    [71, "Lu", "Lutetium", "lanthanide", null, 6, "lanthanide", "Lutetium is used in machines that take medical scans.", "💡"],
    ...
    [80, "Hg", "Mercury", "transition metal", 12, 6, "main", "Mercury is the silver liquid metal in old thermometers.", "🌡️"],
    ...
    [87, "Fr", "Francium", "alkali metal", 1, 7, "main", "Francium is very rare in nature, and it lasts only a short time.", "🧪"],
    [88, "Ra", "Radium", "alkaline earth metal", 2, 7, "main", "Radium was used in old glowing paints, but it is radioactive.", "🕰️"],
    [89, "Ac", "Actinium", "actinide", null, 7, "actinide", "Actinium was found in uranium ore, and it glows a soft blue in the dark.", "⚛️"],
    ...
    [96, "Cm", "Curium", "actinide", null, 7, "actinide", "Scientists first made curium in a laboratory, and it helped rovers on Mars study rocks.", "🚀"],
    ...
    [99, "Es", "Einsteinium", "actinide", null, 7, "actinide", "Scientists first found einsteinium in 1952, and it is one of the rarest elements.", "⚛️"],
    [100, "Fm", "Fermium", "actinide", null, 7, "actinide", "Scientists first found fermium in 1952, and it lasts only a short time.", "🚀"],
